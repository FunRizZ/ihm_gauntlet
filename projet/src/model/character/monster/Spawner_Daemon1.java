...
public class Spawner_Daemon1 extends Spawner {
    public Spawner_Daemon1(int x, int y) {
        super(new Daemon(-1,-1,1).getHp()*2, new Daemon(-1,-1,1).getArmor()*2, new Daemon(-1,-1,1), x, y,1);
    }
